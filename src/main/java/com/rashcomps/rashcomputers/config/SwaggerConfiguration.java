...
public class SwaggerConfiguration extends WebMvcConfigurationSupport{
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2).directModelSubstitute(LocalDate.class, Date.class)
				...
				}).select().apis(RequestHandlerSelectors.basePackage("com.rashcomps.rashcomputers.controllers"))
	...
	private ApiInfo apiInfo() {
		return new ApiInfoBuilder().title("rash ed app apis documentation by swagger2").description("APIs Documentation")
				.termsOfServiceUrl("http://www.rashed.rw/")
				.version("1.0").build();
	}
}